function [ A ] = getIncidenceMatrix( edges, vertices, O_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN, initECount, edgeWeightMap)
%GETINCIDENCEMATRIX Returns the incidence matrix of a semi weighted graph
