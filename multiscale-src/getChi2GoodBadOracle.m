function [distn, edgeTags] = getChi2GoodBadOracle(edges, vertices, gtMatFileName, O_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, t_scale)
%GETCHI2GOODBADORACLE Good Bad oracle using chi2 error produced by each of 
...
A  = getChi2IncidenceMatrix(edges, vertices, O_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN);
