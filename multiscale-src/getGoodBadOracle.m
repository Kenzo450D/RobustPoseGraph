function [distn, edgeTags] = getGoodBadOracle(edges, vertices, gtMatFileName, O_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, t_scale)

% -- get incidence matrix
% A  = getLineDescriptorIncidenceMatrix(edges, vertices, O_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN, [], []);
A  = getOracleIncidenceMatrix( gtMatFileName, edges, vertices, O_EDGE_DIST_MEAN, LC_EDGE_DIST_MEAN, OLC_EDGE_DIST_MEAN);
